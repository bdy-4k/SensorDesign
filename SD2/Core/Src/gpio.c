...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(PWR_CTR_GPIO_Port, PWR_CTR_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, LED_Pin|BUZZ_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : PWR_CTR_Pin */
  GPIO_InitStruct.Pin = PWR_CTR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PWR_CTR_GPIO_Port, &GPIO_InitStruct);
